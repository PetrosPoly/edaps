...
_base_ = [
		...
		"../_base_/datasets/uda_synthia_to_cityscapes_maskrcnn_panoptic_debug.py",
...
work_dir =  "work_dirs/local-exp1/230401_1734_syn2cs_dacs_rcs001_cpl_maskrcnn_mitb5_poly10warm_s0_ffbee",
