...
def rgb2id(color):
    ...
    if isinstance(color, np.ndarray) and len(color.shape) == 3:
        ...
        return color[:, :, 0] + 256 * color[:, :, 1] + 256 * 256 * color[:, :, 2] # Petros :: if color is an array (760,1280,3)
    return int(color[0] + 256 * color[1] + 256 * 256 * color[2]) # Petros :: if color is a tuple
