...
from w_pan_rois_bbox_viz.panoptic_and_rois_vis_functions import load_annotations_bbox_panoptic, subrois_per_bbox, save_and_plot_synthia_gt_pan
...
if __name__ == '__main__':
    ...
    outdir='w_new_pan_rois_bbox_viz/output_visualizations/synthia/panoptic_gt/'
    ...
    roi_dicts = subrois_per_bbox(img_infos) if args.subrois else None
    
    # Plot the RGB image with the bounding boxes
    save_and_plot_synthia_gt_pan(data_root, ann_dir, image_filename, outdir, roi_dicts, args.subrois ,debug)