...
if __name__ == '__main__':
    ...
    ann_dir='gtFine_panoptic/cityscapes_panoptic_train_trainId/aachen/'
    img_dir = 'leftImg8bit/train/aachen'
    image_filename = 'aachen_000003_000019_gtFine_panoptic.png'
    outdir='w_Petros/bbox_visualization_per_instance/output_visualizations_real'
